...
import login from "../assets/assets/register.webp"
    ...
    return (
        <div className='flex'>
            <div className='w-full md:w-1/2 flex flex-col  justify-center items-center p-8 md:p-12'>
                <form onSubmit={onSubmit} className='w-full max-w-md bg-white p-8 rounded-lg border shadow-sm'>
                    ...
                    <button type='submit' className='w-full bg-black text-white rounded font-semibold p-2 hover:bg-gray-800 transition'> Sign In</button>
